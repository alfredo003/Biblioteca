  ...
  <div
    ...
    <form action="">
      <table class="table table-bordered table-striped">
        ...
        <tr>
          <td>Nome :</td>
          <td><input type="text" name="" id="" value="<?php echo $_SESSION['username']?>"></td>
        </tr>
        <tr>
          <td>Email / Telefone :</td>
          <td><input type="text" name="" id="" value="<?php echo $_SESSION['email']?>"></td>
        </tr>
        <tr>
          <td>Tipo de Conta :</td>
          <td><input type="text" name="" id="" value="<?php echo $_SESSION['type']?>">
          </td>
        </tr>
        <tr>
          <td>Codigo de Acesso :</td>
          <td><input type="text" name="" id="" value="<?php echo $_SESSION['username']?>"><a class="text-error"></a>
          </td>
        </tr>
        <tr>
          <td>Palavra-Passe :</td>
          <td><input type="text" name="" id="" value=" "><a class="text-error"></a>
          </td>
        </tr>

      </table>
      <button>Actualizar os Dados</button>
    </form>
  </div>
</body>
