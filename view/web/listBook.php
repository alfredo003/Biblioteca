...
$downloads=$pdo->prepare("SELECT * FROM `downloads` where user = {$_SESSION['codAccess']}");
$downloads->execute();
...
?>
               ...
               $c=0;
                ...
                <div class="main_box">
                  ...
                  <div class="legend">
                    ...
                    <span>Autot:<?=$book['nameAuthor']?></span>
                  </div>


                  <a class="btn btn-success" onclick="saveDownload(<?=$_SESSION['codAccess']?>,<?=$book['id']?>)"
                    target="_blank" href="./../../uploads/book/<?=$book['file']?>">Download</a>
                  <button class="btn btn-info" style="background:#003399; color:#fff;"
                    onclick="saveBook(<?=$_SESSION['codAccess']?>,<?=$book['id']?>)">Guardar</button>
    ...
    <script src="../assets/js/saveBook.js"></script>
